...
for j in range(iterations):
    ...
    if (j % 10 == 0):
        ...
        test_acc = test_correct_cnt/float(len(test_images))
        train_error = str(error/float(len(images)))[0:5]
        train_acc = correct_cnt/float(len(images))
        sys.stdout.write(
            "\n I: {} Test Error: {} Test Acc: {} Train Error: {} Train Acc: {}".format(j, test_error, test_acc, train_error, train_acc))
